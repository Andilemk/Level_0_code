...
print(f"The degrees converted from farenheit to celsius are: {convert_to_celsius(77)}")

print(f"The degrees converted from celsius to farenheit are: {convert_to_farenheit(25)}")
